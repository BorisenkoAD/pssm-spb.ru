...
<head>
    ...
    <title>Отзывы о Компании ПромСтройСпецМонтаж</title>
	...
	<section class="header-top">
		<div class="row">
			...
			<div  style="padding-top: 9px;">
				<a href="\"><span class="nameOfCompany">PSSM</span></a>
			</div>
			</div>
			<div class="col-sm-6 text-right" style="padding-top: 31px; padding-right: 30px;">
				<span class="writeToUs">Напишите нам</br><a href="mailto:info@pssm-spb.ru">info@pssm-spb.ru</a></span>
			</div>
		</div>	
	</section>
	...
	<section class="header-bar">		
		<div class="row">
			...
			<div class="col-sm-10">
				...
				<p class="text-left">Вы можете прочитать, что думают о Компании сотрудники и партнёры. А также оставить своё мнение о работе или сотрудничестве с ООО ПромСтройСпецМонтаж. С нетерпением ждём Ваших отзывов!</p>
			</div>
		</div>
	</section>
	</header>
...
<div class="container">
	<footer>
		<div class="row" style="margin-left: 0px; margin-right: 0px; padding-top: 22px;">
			...
			<div class="col-sm-3 ">
				<span class="nameOfCompanyFooter">PSSM</span>
			</div>
		</div>
		<div class="row" style="padding-top: 22px;">
			...
			<div class="col-sm-6">
				...
				<a href="mailto:info@pssm-spb.ru">info@pssm-spb.ru</a></br>
